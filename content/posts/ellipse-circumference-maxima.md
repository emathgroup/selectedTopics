...
如hujunhua在[url]/thread-3740-1-2.html[/url] 帖子的6层所说：“椭圆外一点向椭圆的张角与向椭圆两焦点的张角同角平分线。”所以它们共法线了。
...
椭圆的切线有个性质——
[b]引理[/b]  过椭圆外一点Y做两射线与椭圆相切，切点分别为H,K。设距切点最近相应的焦点分别为F1,F2。那么∠F1YH=∠F2YK。

首先，在每个瞬时AP有增长的趋势，BP有缩短的趋势，于是P点速度方向是AP,BP方向上速度的合成。
由于绳长一定，那么运动过程中[color=#a0522d]AP减少的长度[/color]=[color=#a0522d]BP增加的长度[/color]。因此在每个[color=#0000ff]瞬时[/color]其速度方向分别是沿AP向量方向和PB向量方向，且速度大小$v_{Ap}=v_{BP}$。根据平行四边形法则可知，合速度方向一定是沿着∠APB的外角平分线方向。而∠APB的内角平分线一定是与外角平分线垂直的，因此P点的速度方向（即轨迹切线方向）一定垂直于∠APB的内角平分线。
根据上面的引理，可知∠APB的内角平分线一定是∠F1PF2的内角平分线，且同时垂直于P点速度方向。由于满足光线反射定律[sup]*[/sup]，因此P点运动轨迹是以F1,F2为焦点的椭。
